...
5. Open terminal and type in ```macALR -v```  
6. If you see this, ```macALR: Fatal: No input file specified``` then skip to step 9  
7. If you did not, go to the search tab and type in ```bashrc.sh``` and open it  
...
10. For information on how to use the command, type in ```macALR -h``` in terminal
